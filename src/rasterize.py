...
APIs:
- points_to_occupancy(points_xy, resolution=0.05, margin=0.5)
- postprocess_occupancy(occ, closing_iters=3)
- occupancy_to_polygon(occ_bin, bbox, resolution)

Dependencies:
    numpy, shapely, opencv-python (cv2), scipy
"""
